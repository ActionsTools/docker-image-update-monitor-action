...
var import_form_data2 = __toModule(require_form_data());
...
// src/dockerhub/dockerhub.ts
var Dockerhub = class {
  async getImageDetail(image, tag = "latest") {
    const url2 = "https://hub.docker.com/v2/repositories/" + image + "/tags?name=" + tag;
...
// src/cache.do.ts
var CacheDo = class {
  constructor(name, tag, cacheUpdateTime) {
    this.name = name;
    this.tag = tag;
